...
struct R: Rswift.Validatable {
  ...
  struct nib {
    /// Nib `ListCellView`.
    static let listCellView = _R.nib._ListCellView()
    ...
    static let metabolicTypeView = _R.nib._MetabolicTypeView()
    /// Nib `ResultBarView`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UINib(name: "ListCellView", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.listCellView) instead")
    static func listCellView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.listCellView)
    }
    #endif
    ...
    @available(*, deprecated, message: "Use UINib(resource: R.nib.metabolicTypeTableViewCell) instead")
    static func metabolicTypeTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.metabolicTypeTableViewCell)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "MetabolicTypeView", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.metabolicTypeView) instead")
    static func metabolicTypeView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.metabolicTypeView)
    }
    #endif
    ...
    static func listCellView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.listCellView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }
    ...
    static func metabolicTypeView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.metabolicTypeView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }
...
struct _R: Rswift.Validatable {
  ...
  #if os(iOS) || os(tvOS)
  struct nib {
    struct _ListCellView: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "ListCellView"
    ...
    struct _MetabolicTypeTableViewCell: Rswift.NibResourceType {
      ...
      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> MetabolicTypeTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? MetabolicTypeTableViewCell
      }

      fileprivate init() {}
    }

    struct _MetabolicTypeView: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "MetabolicTypeView"
