...
//  StoreSearch
//
//  Created by aleksandar on 19.11.21..
//
...
class LandscapeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //Remove constraints for main view
    ...
    private func showNothingFoundLabel() {
        ...
        label.text = NSLocalizedString("Nothing Found", comment: "When nothing is found: Nothing Found")
