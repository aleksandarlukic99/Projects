...
//  MyLocations
//
//  Created by aleksandar on 13.10.21..
//
...
class CurrentLocationViewController: UIViewController, CLLocationManagerDelegate, CAAnimationDelegate {
    ...
    @IBOutlet weak var longitudeTextLbel: UILabel!
    ...
    func updateLabels() {
        if let location = location {
            ...
            longitudeTextLbel.isHidden = false
            ...
            longitudeTextLbel.isHidden = true
    ...
    func hideLogoView() {
        ...
        let logoRotator = CABasicAnimation(keyPath: "transfomation.rotation.z")
